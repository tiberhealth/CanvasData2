...
default_max_lock_attempts = 5
default_sleep_between_attempts_seconds = 1
default_thread_pause = .25

default_namespace = "canvas"
default_api_url = "https://api-gateway.instructure.com"

default_log_level = LogLevel.DETAIL
